...
$(document).ready(function() {
  ...
  $("#from, #to").click(function(e) {
    ...
    // Hide only dropdowns within booking-container
  ...
  // Delegate click event within the booking-container for dropdown items
  ...
  // Hide dropdowns if clicking outside the input-box or booking-container dropdowns
  ...
  // Clear Return date on “One Way” click
